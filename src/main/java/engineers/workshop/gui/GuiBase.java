...
public abstract class GuiBase extends GuiContainer {
	...
	protected static final ResourceLocation BACKGROUND = new ResourceLocation("engineersworkshop",
			"textures/gui/background.png");
	protected static final ResourceLocation ELEMENTS = new ResourceLocation("engineersworkshop",
