...
import us.engineersworkshop.gui.container.slot.SlotBase;
import us.engineersworkshop.item.Upgrade;
import us.engineersworkshop.network.PacketHandler;
import us.engineersworkshop.network.PacketId;
import us.engineersworkshop.network.data.DataType;
...
//        tag.setInteger("power", table.getPower());
        ...
        if (power <= ((TileEntityTable.MAX_POWER * 12.5) / 100)) {
            color = TextFormatting.DARK_RED;
        } else if (power <= ((TileEntityTable.MAX_POWER * 25) / 100)) {
            color = TextFormatting.RED;
        } else if (power <= ((TileEntityTable.MAX_POWER * 37.5) / 100)) {
            color = TextFormatting.GOLD;
        } else if (power <= ((TileEntityTable.MAX_POWER * 50) / 100)) {
            color = TextFormatting.YELLOW;
        } else if (power <= ((TileEntityTable.MAX_POWER * 62.5) / 100)) {
            color = TextFormatting.DARK_GREEN;
        } else if (power <= ((TileEntityTable.MAX_POWER * 75) / 100)) {
            color = TextFormatting.GREEN;
        } else if (power <= ((TileEntityTable.MAX_POWER * 87.5) / 100)) {
