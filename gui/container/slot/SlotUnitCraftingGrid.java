...
public class SlotUnitCraftingGrid extends us.engineersworkshop.gui.container.slot.SlotUnit {
    ...
    public boolean canAcceptItem(ItemStack item) {
        if (getHasStack() && item != null) {
            us.engineersworkshop.page.unit.UnitCrafting crafting = (UnitCrafting)unit;
